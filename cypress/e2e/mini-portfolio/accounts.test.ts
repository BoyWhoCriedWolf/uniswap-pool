...
describe("Mini Portfolio account drawer", () => {
  ...
  it("fetches account information", () => {
    ...
    cy.get(getTestSelector("mini-portfolio-navbar"))
      .contains("Activity")
      .click();
    cy.get(getTestSelector("mini-portfolio-page")).contains(
    ...
    cy.hardhat().then((hardhat) => {
      ...
      cy.get(getTestSelector("portfolio-total-balance"))
        ...
        .then((originalBalance) => {
          ...
          cy.window().then((win) =>
            win.ethereum.emit("accountsChanged", [accountB])
          );
          ...
          cy.get(getTestSelector("portfolio-total-balance")).should(
            "not.have.text",
            originalBalance
          );
        });
  ...
  it("fetches ENS name", () => {
    cy.hardhat().then(() => {
      ...
      cy.window().then((win) =>
        win.ethereum.emit("accountsChanged", [haydenAccount])
      );
