...
export const Trace = memo(
  (props: React.ComponentProps<typeof AnalyticsTrace>) => {
    const allowAnalytics = useAtomValue(allowAnalyticsAtom);
    const shouldLogImpression = allowAnalytics
      ? props.shouldLogImpression
      : false;

    return (
      <AnalyticsTrace {...props} shouldLogImpression={shouldLogImpression} />
    );
  }
);
...
export const TraceEvent = memo(
  (props: React.ComponentProps<typeof AnalyticsEvent>) => {
    const allowAnalytics = useAtomValue(allowAnalyticsAtom);
    const shouldLogImpression = allowAnalytics
      ? props.shouldLogImpression
      : false;
    ...
    return (
      <AnalyticsEvent {...props} shouldLogImpression={shouldLogImpression} />
    );
  }
);
