...
describe("ConfirmationModalContent", () => {
  it("should render the L2 icon for optimism", () => {
    render(
      <ConfirmationModalContent
        ...
        headerContent={() => (
          <div data-testid="confirmation-modal-chain-icon">headerContent</div>
        )}
      />
    );
    expect(
      screen.getByTestId("confirmation-modal-chain-icon")
    ).toBeInTheDocument();
  });
  ...
  it("should not render a chain icon", () => {
    ...
    expect(
      screen.queryByTestId("confirmation-modal-chain-icon")
