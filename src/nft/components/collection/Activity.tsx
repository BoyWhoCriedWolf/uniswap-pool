...
const FilterBox = styled.div<{ isActive: boolean }>`
  ...
  color: ${({ isActive, theme }) =>
    isActive ? theme.neutral1 : theme.neutral1};
  background: ${({ isActive, theme }) =>
    isActive ? theme.surface3 : theme.surface1};
  border: ${({ isActive, theme }) =>
    `1px solid ${isActive ? theme.surface3 : theme.surface3}`};
  ${OpacityHoverState};
`;
        ...
        nftActivity && (
          <Column marginTop="36">
            ...
            <InfiniteScroll
              ...
              loader={
                isLoadingMore ? <ActivityPageLoader rowCount={2} /> : null
              }
