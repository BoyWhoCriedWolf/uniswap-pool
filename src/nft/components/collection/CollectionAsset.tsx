...
import {
  Ranking as RankingContainer,
  Suspicious as SuspiciousContainer,
} from "nft/components/card/icons";
...
export const CollectionAsset = ({
  ...
  const provider = asset?.rarity?.providers
    ? asset.rarity.providers[0]
    : undefined;
    ...
    return {
      ...
      primaryInfoRight:
        asset.rarity && provider ? (
          <RankingContainer provider={provider} />
        ) : null,
