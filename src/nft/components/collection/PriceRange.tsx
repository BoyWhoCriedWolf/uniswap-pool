...
export const PriceRange = () => {
  ...
  const updateMinPriceRange = (v: FormEvent<HTMLInputElement>) => {
    ...
    if (v.currentTarget.value) {
      ...
      const newLow = Math.floor(
        100 * (diff / (parseInt(priceRangeHigh) - parseInt(priceRangeLow)))
      );
  ...
  const updateMaxPriceRange = (v: FormEvent<HTMLInputElement>) => {
    ...
    if (v.currentTarget.value) {
      ...
      const newMax = Math.floor(
        100 -
          100 * (range / (parseInt(priceRangeHigh) - parseInt(priceRangeLow)))
      );
      ...
      <Row marginTop="24" marginBottom="12" paddingLeft="8" paddingRight="8">
        <StyledSlider
          ...
          handleStyle={{
            ...
            borderRadius: "4px",
            border: "none",
            boxShadow: darkDeprecatedTheme.deprecated_shallowShadow.slice(
              0,
              -1
            ),
          }}
